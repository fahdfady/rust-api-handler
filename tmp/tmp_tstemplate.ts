...
function GET(req: Request): Response { throw new Error("Not implemented"); }
function POST(req: Request): Response { throw new Error("Not implemented"); }
function PUT(req: Request): Response { throw new Error("Not implemented"); }
function DELETE(req: Request): Response { throw new Error("Not implemented"); }
